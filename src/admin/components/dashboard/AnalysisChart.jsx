        ...
        <div className="chart-container">
            <div className="chart-header">
                ...
                <div className="chart-legend-container">
                    <span className="legend-item"><div className="legend-dot" style={{ backgroundColor: COLORS.housing }}></div>주거</span>
                    <span className="legend-item"><div className="legend-dot" style={{ backgroundColor: COLORS.env }}></div>환경</span>
                    <span className="legend-item"><div className="legend-dot" style={{ backgroundColor: COLORS.transport }}></div>교통</span>
                    <span className="legend-item"><div className="legend-dot" style={{ backgroundColor: COLORS.safety }}></div>안전</span>
                </div>
            </div>
