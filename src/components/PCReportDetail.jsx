                    ...
                    <div className="pcd-body-wrap">
                        ...
                        {!isOwner && (
                            <button
                                ...
                                onClick={toggleLike}
                            >
                                {/* Figma 302:12316 Union: 하트 33x26 (#542aa3) — voted 시 흰색 반전 */}
                                <span className="pcd-vote-icon">
                                    <img src="/figma-assets/icons/report-propose/heart.png" alt="" width="33" height="26" className="pcd-vote-icon-img" />
                                </span>
                ...
                {showResult && (
                    <div className="pcd-result-backdrop" onClick={() => setShowResult(false)}>
                        <div className="pcd-result-modal pcrd-result-modal-override" onClick={(e) => e.stopPropagation()}>
                            ...
                            {/* Figma 302:12345: 구분선 아래는 담당자 코멘트 라벨+날짜만 (본문은 위에 1회) */}
