...
export default function PCDiagnosisForm({ onNavigate }) {
    ...
    const handleSubmit = () => {
        if (!canSubmit) return;
        onNavigate?.('pcDiagnosisDone');
    };

    return (
        <UserPCLayout currentView="pcDiagnosisForm" onNavigate={onNavigate}>
            <div className="pc-diagform-page">
                <div className="pc-diagform-inner">
                                    ...
                                    <div className="pc-diagform-scale" role="radiogroup">
                                        ...
                                        {SCALE.map((s) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <span className="pc-diagform-scale-face">{s.face}</span>
                                                </button>
                                            );
                                        })}
                                    </div>
