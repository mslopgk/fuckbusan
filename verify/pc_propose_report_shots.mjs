// Capture screenshots of all USER:PC 제안/제보 pages.
...
const OUT_DIR = resolve(__dirname, '../verify/screenshots/pc-propose-report');
...
await visit('pcProposeMap',    '01-propose-map');
await visit('pcProposeForm',   '02-propose-form');
await visit('pcProposeDetail', '03-propose-detail');
